...
export function BorderTrailCard2({ children }) {
   return (
      <div className='relative w-[90%] md:w-[500px] rounded-md border border-zinc-300/40 bg-zinc-100 px-4 py-3 dark:border-zinc-700/40 dark:bg-zinc-900'>
         <BorderTrail
            className={cn(
               "bg-linear-to-l from-red-300 via-red-500 to-red-300 transition-opacity duration-300 dark:from-red-700/30 dark:via-red-500 dark:to-red-700/30 opacity-100"
            )}
            size={150}
            transition={{
               ease: [0, 0.5, 0.8, 0.5],
