...
export default function Skills() {
   return (
      <div className='py-16 transition-colors duration-300 -z-10'>
               ...
               >
                  <div className='flex flex-col items-center text-center gap-3'>
                     ...
                     <div className='w-full rounded-full h-3 mt-2 overflow-hidden'>
                        <motion.div
                           className='h-3 rounded-full bg-gradient-to-r from-transparent via-red-200 to-red-300 dark:via-red-400 dark:to-red-500'
                           initial={{ width: 0 }}
